...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(com.subash.agriculturestore.ui.RegisterActivity.this, LoginActivity.class);
                ...
                signUpCall.enqueue(new Callback<SignUpResponse>() {
                    ...
                    public void onResponse(Call<SignUpResponse> call, Response<SignUpResponse> response) {
                        if (!response.isSuccessful()) {
                            Toast.makeText(com.subash.agriculturestore.ui.RegisterActivity.this, "Code " + response.code(), Toast.LENGTH_SHORT).show();
                            return;
                        }
                        Toast.makeText(com.subash.agriculturestore.ui.RegisterActivity.this, "Successfully Registered", Toast.LENGTH_SHORT).show();
                        Intent intent =  new Intent(com.subash.agriculturestore.ui.RegisterActivity.this, MainActivity.class);
                        startActivity(intent);
                    }

                    @Override
                    public void onFailure(Call<SignUpResponse> call, Throwable t) {
                        Toast.makeText(com.subash.agriculturestore.ui.RegisterActivity.this, "Register Unsuccessful" + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
